...
### F. Unified Bloomberg / collector terminal *(deferred; never built)*

- [ ] Bloomberg-style restyle of `apps/iqvault-web`
- [ ] Full comics grid + filters on VIP face (parity with legacy `:5175` IQVault)
...
- [ ] Analysis/insights panel on collector face (non-Console)
