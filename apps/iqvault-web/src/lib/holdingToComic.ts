...
export function holdingToComicRow(h: Holding): ComicRow {
  return {
    ...
    "Inventory Bucket Source": h.inventoryBucketAssignment ?? "",
    "Live Range": h.liveRangeLabel ?? "not fetched",
    "Live Low": h.liveLow ?? null,
    "Live High": h.liveHigh ?? null,
    "Live Listings": h.liveListingCount ?? null,
