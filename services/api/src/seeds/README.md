...
| `pokemon-holdings-sample.json` | Temporary TCG bridge (5 cards) so Binder Sync Owned has `externalIds` to match when Binder SQLite is empty. Not a substitute for full TCG holdings. |
