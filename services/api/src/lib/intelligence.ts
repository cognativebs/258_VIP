...
import type { BinderSummary } from "./binderHoldings.js";
...
export function intelligenceSnapshot(
  ...
  extras?: {
    holdings?: ApiHolding[];
    /**
     * Binder summaries from Postgres `vault_tcg` (ADR 0007). The original
     * draft expected a per-page chase view built on the retired SQLite client;
